...
A.localeStrings = {
	enUS = {
		...
		externalWhispers = "Whisper external targets",
		externalWhispersDescription = "Whisper flagged external target spells to the affected player.",
	...
	koKR = {
		...
		externalWhispers = "외부 대상 귓속말",
		externalWhispersDescription = "표시된 외부 대상 주문을 해당 플레이어에게 귓속말로 보냅니다.",
		channelMode = "알림 채널",
...
A.optionLabels = {
	...
	externalWhispers = A.L.externalWhispers,
}
...
A.optionDescriptions = {
	...
	externalWhispers = A.L.externalWhispersDescription,
}
